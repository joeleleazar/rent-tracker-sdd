            ...
            <form method="GET" action="{{ route('locaciones.recibos.create', $locacion) }}" class="card">
                <div class="card-body d-flex flex-wrap align-items-end gap-3">
                    <div>
                        ...
                        <input id="periodo" name="periodo" type="month" class="form-control form-control-lg" value="{{ $periodo->format('Y-m') }}">
                    </div>
                    ...
                    <div class="card-body d-flex flex-column gap-3">
                        ...
                        <div class="d-flex flex-wrap align-items-center gap-3 border border-2 rounded p-3">
                            <div class="form-check d-flex align-items-center gap-2 flex-shrink-0">
                                ...
                                <label for="incluye_luz" class="form-check-label fs-5 fw-semibold">Incluir Luz (calculado por consumo)</label>
                            </div>
                            <div class="input-group input-group-lg" style="max-width: 16rem;">
                                <span class="input-group-text">S/</span>
