 ...
 * contraseña ingresada es incorrecta (la página se recarga con errores de
 * validación y el modal debe reaparecer ya abierto, igual que hacía el
 * `x-modal` de Alpine con `:show="$errors->...->isNotEmpty()"`).
 */
document.addEventListener('DOMContentLoaded', () => {
    document.querySelectorAll('.modal[data-autoshow="1"]').forEach((elementoModal) => {
