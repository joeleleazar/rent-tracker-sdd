...
| III. Accesibilidad Senior-First | ✅ Formulario de recibo precargado con campos editables ≥18px, botones "Guardar Costos del Contrato"/"Emitir Recibo" ≥48x48px, pantalla de configuración general accesible solo a usuarios autenticados (ver `research.md` §5 sobre roles) |
