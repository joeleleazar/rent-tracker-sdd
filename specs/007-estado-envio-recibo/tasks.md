...
- [X] T011 [US1] Agregar botones "Marcar como Pagado"/"Anular Recibo"/"Revertir Anulación" y modal de confirmación explícita a `resources/views/locaciones/recibos/show.blade.php` (de `specs/004`/`005`) (depende de T010)
